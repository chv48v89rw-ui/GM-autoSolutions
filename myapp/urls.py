...
urlpatterns = [
    ...
    path('dashboard/dealership/analytics/more-metrics/', views.dealership_more_metrics, name='dealership_more_metrics'),
    path('dashboard/dealership/analytics/more-metrics/<str:metric_type>/', views.dealership_more_metrics_detail, name='dealership_more_metrics_detail'),
